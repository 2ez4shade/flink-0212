...
public class Flink01_EventTime_WaterMark_Monotonous {
    public static void main(String[] args) throws Exception {
        ...
        //设置水位线
        //有序流
        SingleOutputStreamOperator<WaterSensor> operator = map.assignTimestampsAndWatermarks(
                WatermarkStrategy
        ...
        //乱序流
        SingleOutputStreamOperator<WaterSensor> operator1 = map.assignTimestampsAndWatermarks(WatermarkStrategy.<WaterSensor>forBoundedOutOfOrderness(Duration.ofMillis(3))
                .withTimestampAssigner(new SerializableTimestampAssigner<WaterSensor>() {
                    @Override
                    public long extractTimestamp(WaterSensor element, long recordTimestamp) {
                        return element.getTs();
        ...
        WindowedStream<WaterSensor, Tuple, TimeWindow> window = operator.keyBy("id").window(TumblingEventTimeWindows.of(Time.milliseconds(5)));
