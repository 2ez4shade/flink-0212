...
public class Flink11_Project_UV {
    public static void main(String[] args) throws Exception {
        ...
        map.flatMap(new FlatMapFunction<UserBehavior, Tuple2<String, Long>>() {
                    @Override
                    public void flatMap(UserBehavior value, Collector<Tuple2<String, Long>> out) throws Exception {
                        if ("pv".equals(value.getBehavior())) {
                            out.collect(Tuple2.of("uv", value.getUserId()));
                        }
                    }
                }).keyBy(0)
                .process(new KeyedProcessFunction<Tuple, Tuple2<String, Long>, Tuple2<String, Long>>() {
                    ...
                    @Override
                    public void processElement(Tuple2<String, Long> value, KeyedProcessFunction<Tuple, Tuple2<String, Long>, Tuple2<String, Long>>.Context ctx, Collector<Tuple2<String, Long>> out) throws Exception {
                        set.add(value.f1);
