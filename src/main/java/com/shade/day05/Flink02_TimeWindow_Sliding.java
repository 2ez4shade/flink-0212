 ...
 * @description:
 */
public class Flink02_TimeWindow_Sliding {
    public static void main(String[] args) throws Exception {
        ...
        WindowedStream<Tuple2<String, Integer>, Tuple, TimeWindow> window = keyBy.window(SlidingProcessingTimeWindows.of(Time.seconds(6),Time.seconds(3)));
